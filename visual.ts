...
export class GdmLiveAudioVisuals extends LitElement {
  ...
  // FIX: Class 'GdmLiveAudioVisuals' incorrectly extends base class 'LitElement'.
  // Property 'firstUpdated' is private in type 'GdmLiveAudioVisuals' but not in type 'LitElement'.
  ...
  // FIX: Class 'GdmLiveAudioVisuals' incorrectly extends base class 'LitElement'.
  // Property 'render' is private in type 'GdmLiveAudioVisuals' but not in type 'LitElement'.
